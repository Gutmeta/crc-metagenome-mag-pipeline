#!/bin/bash
#SBATCH --job-name=fastspar_bootstrap_control_1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=64
#SBATCH --mem=128GB
#SBATCH --output=/path/to/storage/data3/CRC/YachidaS_2019/slurm_out/fastspar_bootstrap_control.out
#SBATCH --error=/path/to/storage/data3/CRC/YachidaS_2019/slurm_out/fastspar_bootstrap_control.err
