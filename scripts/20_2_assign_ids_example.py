...
# ============ 路径配置 ============
fa_dir = "/path/to/data2/CRC/CCDC1_TCG/FengQ_2015/Results/dRep_hq_bins_dir"
summary_path = "/path/to/crc-metagenome-mag-pipeline/classify_wf_out/FengQ_2015/gtdbtk.summary.tsv"
group_path = "/path/to/crc-metagenome-mag-pipeline/FengQ_2015_CRC_Group.txt"
output_path = "/path/to/data2/CRC/CCDC1_TCG/FengQ_2015/Results/gtdbtk_id_mapping_with_unclassified.tsv"
...
def main():
    ...
    group_df["sample_suffix"] = group_df["Sample"].astype(str).str[-7:]
