...
# 配置路径
base_dir = "/path/to/storage/data3/CRC/YachidaS_2019/Results/co_abundance_network_75"
groups = ["CRC", "control"]
pval_cutoff = 0.001

# 读取映射表（包含 ID、GTDBTK、fa_filename）
mapping_path = "/path/to/storage/data3/CRC/YachidaS_2019/Results/gtdbtk_id_mapping_with_unclassified.tsv"
