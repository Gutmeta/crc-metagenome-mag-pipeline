...
# 输入路径
abundance_file = "/path/to/data2/CRC/CCDC1_TCG/FengQ_2015/Results/merged_abundance_with_taxonomy.tsv"
group_file = "/path/to/crc-metagenome-mag-pipeline/FengQ_2015_CRC_Group.txt"
output_base = "/path/to/data2/CRC/CCDC1_TCG/FengQ_2015/Results/co_abundance_network"
