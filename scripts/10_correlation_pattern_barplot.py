...
# === 1. 读取数据 ===
df = pd.read_csv("/path/to/data2/CRC/YachidaS_2019/Results/co_abundance_network_75/2_letter_pattern_counts.tsv", sep="\t")
...
edge_node_df = pd.read_csv("/path/to/data2/CRC/YachidaS_2019/Results/co_abundance_network_75/stable_edge_node_counts.csv")
# 假设文件内容类似于：稳定边数, 节点数
...
plot_visible_segment(ax1, 0, 10)
plot_visible_segment(ax2, 500, 1500)
plot_visible_segment(ax3, 2000, 500000)
...
# === 11. 保存图 ===
plt.savefig("/path/to/data2/CRC/YachidaS_2019/Results/co_abundance_network_75/correlation_pattern_barplot.pdf", dpi=300)
plt.show()
