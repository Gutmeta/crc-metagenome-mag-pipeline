#!/bin/bash
#SBATCH --job-name=fastspar_bootstrap_control_FengQ_2015
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=64
#SBATCH --mem=128GB
#SBATCH --output=/path/to/data2/CRC/CCDC1_TCG/FengQ_2015/slurm_out/fastspar_bootstrap_control.out
#SBATCH --error=/path/to/data2/CRC/CCDC1_TCG/FengQ_2015/slurm_out/fastspar_bootstrap_control.err
