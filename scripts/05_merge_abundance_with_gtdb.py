...
# ==== 配置路径 ====
abundance_dir = "/path/to/storage/data3/CRC/YachidaS_2019/Results/DiTASiC/abundance"
gtdb_summary_file = "/path/to/crc-metagenome-mag-pipeline/classify_wf_out/YachidaS_2019/gtdbtk.summary.tsv"
output_file = "/path/to/storage/data3/CRC/YachidaS_2019/Results/merged_abundance_with_taxonomy.tsv"
