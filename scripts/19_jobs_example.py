...
output_job_dir = '19.DiTASiC_jobs/FengQ_2015'
output_dir = '/path/to/data2/CRC/CCDC1_TCG/FengQ_2015/Results'
input_path = '/path/to/data2/CRC/CCDC1_TCG/FengQ_2015'
slurm_log_dir = '/path/to/data2/CRC/CCDC1_TCG/FengQ_2015/slurm_out'
# 创建脚本输出目录
