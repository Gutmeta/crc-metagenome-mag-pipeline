...
#SBATCH --output=/path/to/data2/CRC/CCDC2/slurm_out/39.pipe.out
#SBATCH --error=/path/to/data2/CRC/CCDC2/slurm_out/39.pipe.err

# 获取输入参数
output_dir=/path/to/data2/CRC/CCDC2_val
ulimit -n 4096

# DiTASiC 计算丰度
#生成 DiTASiC 相似性矩阵和索引
mkdir -p ${output_dir}/DiTASiC
ls /path/to/data2/CRC/CCDC2/CC_TCG_genomes/*.fa > ${output_dir}/DiTASiC/ref_paths.txt
